...
.global in
        ...
        // in:.asciz "def main() { print(11111) xs[3] i = 0 while ( i < 3 ) { xs[i] = i print(xs[i]) i = i + 1 } print(11111) i = 0 ys[3] while ( i < 3 ) { ys[3-i] = xs[i] i = i + 1} print(11111) i = 0 while ( i < 3 ) {print(xs[i]) print(ys[i]) i = i + 1}  } EOP"
        in:.asciz "def main() { xs[3] ys[3] i = 0 while( i < 3 ) {xs[i] = i i = i + 1} i = 0 while( i < 3) {ys[i] = xs[2-i] i = i + 1} i = 0 while( i < 3 ) {print(xs[i]) print(ys[i]) i = i + 1}} EOP"
